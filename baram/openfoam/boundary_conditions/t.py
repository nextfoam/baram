...
from baram.coredb.boundary_db import BoundaryDB, BoundaryType, FlowRateInletSpecification, WallVelocityCondition, WallTemperature
from baram.coredb.boundary_db import TemperatureProfile, TemperatureTemporalDistribution, InterfaceMode
from baram.coredb.material_db import MaterialDB, UNIVERSAL_GAL_CONSTANT
