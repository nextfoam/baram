...
class RefinementItem(QTreeWidgetItem):
    def __init__(self, gId, name, level):
        ...
        self.setText(Column.NAME_COLUMN.value, name)
        self.setText(Column.LEVEL_COLUMN.value, level)
    ...
    def name(self):
        return self.text(Column.NAME_COLUMN.value)

    def level(self):
        return self.text(Column.LEVEL_COLUMN.value)
