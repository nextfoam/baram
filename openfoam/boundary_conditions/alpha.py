...
from coredb.boundary_db import BoundaryDB, BoundaryType, ContactAngleModel, InterfaceMode
    ...
    def _constructBoundaryField(self):
        ...
        for bcid, name, type_ in self._region.boundaries:
            ...
            field[name] = {
                ...
                BoundaryType.FREE_STREAM.value:         (lambda: None),
                ...
                BoundaryType.THERMO_COUPLED_WALL.value: (lambda: None),
                BoundaryType.SYMMETRY.value:            (lambda: self._constructSymmetry()),
                BoundaryType.INTERFACE.value:           (lambda: self._constructInterfaceAlpha(xpath)),
                BoundaryType.POROUS_JUMP.value:         (lambda: None),
                BoundaryType.FAN.value:                 (lambda: None),
                BoundaryType.EMPTY.value:               (lambda: self._constructEmpty()),
                BoundaryType.CYCLIC.value:              (lambda: None),
